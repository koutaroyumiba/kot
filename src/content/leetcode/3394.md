...
questionId: "3394"
questionUrl: "https://leetcode.com/problems/check-if-grid-can-be-cut-into-sections/"
difficulty: "Medium"
type: "daily"
topics: []
solvedAt: "2025-03-25"
...
Then we can use the same algorithm that we used [yesterday](/leetcode/3169) to find the gaps in the x direction and the y direction.
